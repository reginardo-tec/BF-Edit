...
export const Route = createFileRoute("/enviar")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Enviar arquivos — BF Arte & Design" },
      { property: "og:description", content: "Envie fotos, artes e pastas completas para personalizarmos seu produto." },
      { property: "og:url", content: "https://bfartedesign.shop/enviar" },
    ],
    links: [{ rel: "canonical", href: "https://bfartedesign.shop/enviar" }],
  }),
});
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-3xl px-5 py-12 md:py-16">
          <div className="mb-8 flex items-center gap-3">
            <img src={logo} alt="BF Arte & Design" className="h-12 w-12 rounded-full object-contain" />
            <div>
              <h1 className="text-3xl font-semibold" style={{ fontFamily: '"Cormorant Garamond", serif' }}>
                Enviar arquivos
              </h1>
